...
<div class="login_box">
  ...
  <form method = "post" action="">
	...
	margin: 8px 0;
	"><b>Email:</b></td>
	   <td colspan="3"><input style="background-color: white;
	border: box;
	padding: 12px 15px;
	margin: 8px 0;
	width: 30%; type="text" name="email" required placeholder="Email" /></td>
	  </tr>
	...
	padding: 12px 15px;
	margin: 8px 0;
	width: 30%;" type="password" name="password" required placeholder="Password" /></td>
	  </tr>
